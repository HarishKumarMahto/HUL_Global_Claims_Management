...
export default function SPARCiPanel({
  isOpen,
  onClose,
  asset,
  onAcceptClaim,
    ...
    const updated: Asset = {
      ...
      auditLog: [
        ...asset.auditLog,
        {
          ...
          action: `SPARCi: ${nonDups.length} claim(s) created from OCR extraction`,
          actor: 'Current User',
          timestamp: new Date().toISOString(),
          details: 'Model: sparci-v2.1 | Duplicate check: passed',
        },
      ],
    };
